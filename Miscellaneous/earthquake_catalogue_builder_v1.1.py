...
db_path = '/run/media/visser/mybook/brindley/dbs/nbc_2014-2016/'
db_name = 'nbc_2014-2016'
...
if os.path.exists('../output_files/sta_magV1.1.txt'):
    os.remove('../output_files/sta_magV1.1.txt')

with open('../output_files/sta_magV1.1.txt', 'a') as the_file:
    for i in orid_list:
